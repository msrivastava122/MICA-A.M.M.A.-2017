...
{
  if(d3$sex[i]=="F")
  {  women_mean_grade = women_mean_grade + d3$G3.x[i] + d3$G3.y[i]
  }
  else
  {
    men_mean_grade = men_mean_grade + d3$G3.x[i] + d3$G3.y[i]
  }
}
men_mean_grade = men_mean_grade/length(d3$G3.x)
women_mean_grade = women_mean_grade/length(d3$G3.x)

men_mean_grade
women_mean_grade  ####Part 1 ends here
